                     ...
                     <div class="white_shd full margin_bottom_30">
                        <div class="full graph_head">
                           <div class="d-flex justify-content-between align-items-center">
                              ...
                              <div>
                                 @if ($overview)
                                    <button id="editOverviewBtn" 
                                          class="btn btn-success"
                                          data-bs-toggle="modal" 
                                          data-bs-target="#myModal"
                                          data-overview-id="{{ $overview->id }}"
                                          data-overview-image="{{ $overview->image }}"
                                 ...
                                 @else
                                    <button id="addOverviewBtn"
                                          class="btn btn-success"
                                          data-bs-toggle="modal" 
                                          data-bs-target="#myModal">
                                          <i class="fa fa-plus-circle mx-2"></i> Add Overview
                                    </button>
                                 @endif
                              </div>
                           </div>
                        ...
                        <div class="table_section padding_infor_info">
                           <div id="overviewView" style="color:black">
                              @if ($overview)
                                 <img src="{{ asset('storage/' . $overview->image) }}" width="200" class="mb-3" />

                                 <h4>Mission</h4>
                                 <p>{!! nl2br(e($overview->mission)) !!}</p>
