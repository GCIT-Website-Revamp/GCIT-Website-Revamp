            ...
            <div class="courseDetailsSection">
                ...
                <div class="sideMenu">
                    ...
                    <div class="menuSection">
                        ...
                        <a href="#year1sem1Section">General Eligibility</a>
                        <a href="#year1sem2Section">Program-Specific Requirement</a>
                        <a href="#year2sem1Section">Selection and Merit Ranking</a>
                        <a href="#year2sem2Section">Required Documentation</a>
                        <a href="#year3sem1Section">Application Process</a>
                        <a href="#year3sem2Section">Additional Information</a>
                    </div>
                </div>
    ...
    <div class="courseDetailsWrapper greyContainer">
        ...
        <section id="intake">
                    <div class="courseHeaderWrapper">
                            ...
                            <img src="{{ asset('images/admission-group.jpg') }}" alt="GCIT Students" class="contentImage">
                        </div>
