                        ...
                        <div class="courseDetailsWrapper greyContainer">
                            ...
                            <section id="intake">
                                <div class="courseHeaderWrapper">
                                    ...
                                    <p>The online application for Gyalpozhing College of Information Technology will open on
                                        <strong class="orange"> 1st March </strong>and <strong class="orange">close on 15th
                                            March 2026.</strong>
                                    </p>
                                    <br>
                                    <p>
                                        Students wishing to seek admission into GCIT may apply through the Royal University
                                        of Bhutan
                            ...
                            <section id="criteria">
                                <div class="courseHeaderWrapper admissionWrap">
                                    ...
                                    <p>
                                        Admission to undergraduate programmes at GCIT is governed by the <a
                                            href="https://www.rub.edu.bt/index.php/admission-criteria-and-tuition-fee-for-the-academic-year-2024/">
                                            Royal University of Bhutan (RUB)
                                            admission regulations</a> and the college’s programme-specific entry
                                        requirements.
                                        Eligible applicants must meet the criteria and submit all required documentation
                                        within the
                            ...
                            <section id="eligibility" class="miniAdmissionSection">
                                ...
                                <ul>
                                    <li>Completion of the Bhutan Higher Secondary Education Certificate (BHSEC) or an
                                        equivalent qualification.</li>
                                    <li>Pass in Dzongkha as required under RUB admission policy or successful completion of
                                        a RUB-administered language assessment where applicable.</li>
                                    <li>Proficiency in English, typically demonstrated through Class XII results or an
                                        equivalent recognised assessment.</li>
                                </ul>
                            </section>
                            ...
                            <section id="programme" class="miniAdmissionSection">
                                ...
                                <ul>
                                    <li>Applicants must have passed Class XII with minimum performance in Mathematics or
                                        Business Mathematics as specified for ICT-related programmes.</li>
                                    <li>Selection is competitive and based on merit ranking in accordance with RUB’s ability
                                        rating and subject weighting system.</li>
                                </ul>

                                <p>
                                    Merit ranking and subject weighting, including Mathematics and English, are determined
                                    centrally by RUB
                            ...
                            <section id="selection" class="miniAdmissionSection">
                                ...
                                <p>
                                    Selection of candidates is based on academic performance and merit ranking as prescribed
                                    by RUB.
                                    Class XII subject performance is used to compute ability rating points, which are ranked
                                    to determine
                                    offers of admission.
                                </p>
                            </section>
                            ...
                            <section id="process" class="miniAdmissionSection">
                                ...
                                <ol>
                                    ...
                                    <li>Applications are verified for eligibility and shortlisted based on academic merit.
                                    </li>
                                    <li>Final admission offers are issued by RUB/GCIT based on merit ranking and seat
                                        availability.</li>
                                </ol>

                                <p>
                                    Applications received after the deadline or that do not meet eligibility requirements
                            ...
                            <section id="additional" class="miniAdmissionSection">
                                ...
                                <p>
                                    Admission to GCIT programmes is competitive due to limited intake relative to the number
                                    of qualifying applicants.
                                    Applicants are encouraged to review official RUB admission announcements for
                                    programme-specific details
                                    and annual updates.
                                </p>
                                <br>
                                <p>
                                    GCIT reserves the right to update admission criteria in alignment with RUB policies and
