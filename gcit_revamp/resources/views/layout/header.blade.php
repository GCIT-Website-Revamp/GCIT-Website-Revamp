    ...
    <div class="navContent wrapper">
        ...
        <div class="linkWrapper">
            ...
            <div class="dropDownWrapper">
                <label class = "dropDownLink" for="academicToggle">Students<span class="material-symbols-outlined">arrow_drop_down</span></label>
                 <div class="dropDownContent">
                    ...
                    <a class = "subLink" href="">ICT</a>
                    <a class = "subLink" href="">Student Welfare</a>
                </div>
            </div>
            <div class="dropDownWrapper">
            ...
            <div class="dropDownWrapper">
                ...
                <label class = "search" for="academicToggle"><span class="material-symbols-outlined">search</span></label>
        </div> 
    </div>
