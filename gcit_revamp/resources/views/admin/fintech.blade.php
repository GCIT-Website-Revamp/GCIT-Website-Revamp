...
<body class="inner_page tables_page">
                  ...
                  <div class="row column_title">
                     <div class="col-md-12">
                        <div class="page_title">
                           <h2>GCITxBIL Fintech Innovation Lab</h2>
                        </div>
                     </div>
                  </div>
                  <!-- row -->
                     ...
                     <div class="white_shd full margin_bottom_30">
                        <div class="full graph_head">
                           <div class="d-flex justify-content-between align-items-center">
                              ...
                              <div>
                                 @if ($fintech)
                                    <button id="editFintechBtn" 
                                          class="btn btn-success"
                                          data-bs-toggle="modal" 
                                          data-bs-target="#myModal"
                                          data-fintech-id="{{ $fintech->id }}"
                                          data-fintech-name="{{ $fintech->name }}"
                                          data-fintech-roles="{{ json_encode($fintech->roles) }}"
                                          data-fintech-description="{{ $fintech->description }}"
                                    >
                                          <i class="fa fa-pencil mx-2"></i> Edit Info
                                    </button>
                                 @else
                                    <button id="addFintechBtn"
                                          class="btn btn-success"
                                          data-bs-toggle="modal" 
                                          data-bs-target="#myModal">
                        ...
                        <div class="table_section padding_infor_info">
                           <div id="fintechView" style="color:black">
                              @if ($fintech)
                                 <h4>Title</h4>
                                 <p>{!! nl2br(e($fintech->name)) !!}</p>
                                <h4>Roles</h4>
                                <div class="row">
   ...
   <script src="{{ asset('js/admin/fintech.js') }}"></script>
</body>
