                        ...
                        <div class="courseDetailsWrapper greyContainer">
                            ...
                            <section id="intake">
                                ...
                                <div id="intake-overview" class="miniAdmissionSection">
                                    ...
                                    <div class="courseHeaderWrapper">
                                        <p>
                                            Gyalpozhing College of Information Technology (GCIT) is pleased to announce that
                                            applications are now open for our <strong>Undergraduate Programme</strong> and
                                            our <strong>Joint Study Programme in collaboration with Jigme Namgyel
                                                Engineering College (JNEC).</strong>
                                        </p>
                                        <br>
                                        <p>
                                            Interested students must apply online via the official portal within the
                                            specified window:<br>
                                            <strong>Application Portal:</strong> <a href="https://admission.gcit.edu.bt"
                                                target="_blank" class="orange">https://admission.gcit.edu.bt</a><br>
                                            <strong>Application Period:</strong> <strong class="orange">March 1</strong> –
                                            <strong class="orange">March 15, 2026.</strong>
                                        </p>
                                        <img src="{{ asset('images/admission-group.png') }}" alt="GCIT Students"
                                            class="admissionImg" style="margin-top: 20px;">
                                    </div>
                                </div>
                                ...
                                <div id="intake-timeline" class="miniAdmissionSection">
                                    ...
                                    <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eee;"><strong>Online
                                                        Application Window</strong></td>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eee;">March 1 – March
                                                    15, 2026</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eee;">
                                                    <strong>Notification of Shortlisted Candidates (for CTT)</strong></td>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eee;">March 31 – April
                                                    2, 2026</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eee;">
                                                    <strong>Computational Thinking Test (CTT) Day</strong></td>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eee;">April 11, 2026
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eee;">
                                                    <strong>Notification of Shortlisted Candidates (for Interview)</strong>
                                                </td>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eee;">April 10, 2026
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eee;"><strong>Online
                                                        Interview Period</strong></td>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eee;">April 12 – April
                                                    16, 2026</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eee;"><strong>Final
                                                        Selection Notification (Email & Call)</strong></td>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eee;">April 17, 2026
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;"><strong>Official Result Web Publication</strong>
                                                </td>
                            ...
                            <section id="gcit">
                                ...
                                <div id="gcit-available" class="miniAdmissionSection">
                                    ...
                                    <p>
                                        Gyalpozhing College of Information Technology (GCIT) offers Bachelor’s programmes
                                        meticulously designed to cultivate technical excellence and foster innovative
                                ...
                                <div id="gcit-eligibility" class="miniAdmissionSection">
                                    ...
                                    <ul>
                                        <li>Applicants must be Class XII graduates with a minimum of <strong>50% in
                                                Mathematics or Business Mathematics</strong>.</li>
                                    </ul>
                                    <br>
                                    ...
                                    <ul>
                                        <li>Shortlisted applicants must sit for the <strong>Computational Thinking Test
                                                (CTT)</strong>. Candidates will be further shortlisted for a personal
                                            interview based on CTT scores.</li>
                                        <li><strong>Final Selection Formula:</strong> 40% Ability Rating points, 40% CTT
                                            score, and 20% personal interview.</li>
                                    </ul>
                                </div>
                            </section>
                            ...
                            <section id="joint">
                                ...
                                <div id="joint-available" class="miniAdmissionSection">
                                    ...
                                    <p>
                                        The Joint Study Programme integrates the specialized expertise of both GCIT and JNEC
                                        to provide a rigorous and comprehensive academic pathway in cybersecurity:
                                    </p><br>
                                    <ul>
                                    ...
                                    <ul>
                                        <li><strong>Years 1 & 2:</strong> Hosted at Jigme Namgyel Engineering College
                                            (JNEC), Dewathang.</li>
                                        <li><strong>Years 3 & 4:</strong> Hosted at Gyalpozhing College of Information
                                            Technology (GCIT), Thimphu.</li>
                                    </ul>
                                </div>
                                ...
                                <div id="joint-eligibility" class="miniAdmissionSection">
                                    ...
                                    <p><strong>Academic Eligibility:</strong></p>
                                    <ul>
                                        <li>Open to Class XII <strong>Science graduates</strong> with a pass in Mathematics.
                                        </li>
                                    </ul>
                                    <br>
                                    <p><strong>Ability Rating Point Criteria:</strong></p>
                                    ...
                                    <p><strong>Selection Process:</strong></p>
                                    <ul>
                                        <li>Shortlisted applicants are required to undergo the <strong>Computational
                                                Thinking Test (CTT)</strong>.</li>
                                        <li><strong>Final Selection Formula:</strong> 50% Ability Rating points and 50% CTT
                                            score.</li>
                                    </ul>
                                </div>
                            </section>
                            ...
                            <section id="additional">
                                ...
                                <div id="documents" class="miniAdmissionSection">
                                    ...
                                    <p>Selected candidates must provide the following documents during the official
                                        registration process (Original + 1 Copy):</p>
                                    <ul>
