                                    ...
                                    @forelse ($users as $index => $user)
                                       <tr>
                                          ...
                                          <td style="max-width:80px;">
                                             <form action="{{ route('toggleUser', $user->id) }}" method="POST" class="toggle-user-form" data-username="{{ $user->name }}">
                                                @csrf
                                                @method('PUT')
                                                <button type="submit" class="btn btn-{{ $user->enabled ? 'orange' : 'success' }}">
