                                 ...
                                 <tbody>
                                    @forelse ($events as $index => $event)
                                       <tr>
                                          ...
                                          <td style="max-width: 80px;"><img src="{{ asset('storage/' . $event->image) }}" alt="Event Image"
                                                width="80"></td>
                     ...
                     <div class="white_shd full margin_bottom_30">
                        <div class="full graph_head">
                           <div class="d-flex justify-content-between align-items-center">
                              ...
                              <div>
                                 <button id="addAnnouncementBtn" type="button" class="btn btn-success" data-bs-toggle="modal"
                                    data-bs-target="#myModal" aria-haspopup="true" aria-controls="myModal">
