...
document.getElementById('addServiceBtn').addEventListener('click', function () {
    ...
    document.getElementById('addService').addEventListener('click', function () {
        ...
        Swal.fire({
            title: "Add Service?",
            text: "Do you want to create this new service?",
            icon: "question",
...
document.querySelectorAll('.edit-service-btn').forEach(button => {
    button.addEventListener('click', function () {
        ...
        const serviceRoles = JSON.parse(this.dataset.serviceRoles || "[]");
        ...
        document.querySelector('#myModal .modal-body').innerHTML = `
            <form id="editServiceForm" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-group">
                    <label for="description">Description</label>
                    <textarea class="form-control" id="description" name="description" rows="7" required>${serviceDescription}</textarea>
                </div>
                <div class="form-group">
                    <label>Roles</label>
