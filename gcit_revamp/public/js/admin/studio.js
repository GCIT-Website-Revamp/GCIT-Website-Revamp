...
// =====================
document.getElementById('addStudioBtn')?.addEventListener('click', function () {
    document.querySelector('#myModal .modal-title').textContent = 'Add Studio Information';

    document.querySelector('#myModal .modal-body').innerHTML = `
        <form id="addStudioForm" enctype="multipart/form-data" autocomplete="off">
...
// Edit Service Button
// =============================
document.getElementById('editStudioBtn')?.addEventListener('click', function () {
        const studioId = this.dataset.studioId;
        const studioName = this.dataset.studioName;
        const studioDescription = this.dataset.studioDescription;
        const studioRoles = JSON.parse(this.dataset.studioRoles || "[]");
        ...
        document.querySelector('#myModal .modal-body').innerHTML = `
            <form id="editServiceForm" enctype="multipart/form-data" autocomplete="off">
                <div class="form-group">
                    <label for="name">Title</label>
                    <input type="text" class="form-control" id="name" name="name" value="${studioName}" required>
                </div>
                <div class="form-group">
                    <label for="description">Description</label>
                    <textarea class="form-control" id="description" name="description" rows="7" required>${studioDescription}</textarea>
                </div>
                <div class="form-group">
                    <label>Roles</label>
